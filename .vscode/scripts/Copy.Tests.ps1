...
try {
    ...
    $repositoryVersionUrl = "https://github.com/laicasaane/BakingSheet/blob/6.3.1-pre.3+build.7"
    $rawRepositoryVersionUrl = "https://raw.githubusercontent.com/laicasaane/BakingSheet/6.3.1-pre.3+build.7"
    ...
    Assert-Content "UnityProject/Packages/com.laicasaane.bakingsheet/README.md" "[docs]($repositoryVersionUrl/docs/guide.md)`n![image]($rawRepositoryVersionUrl/.github/images/sample.png)"
    Assert-Content "UnityProject/Packages/com.laicasaane.bakingsheet/CHANGELOG.md" "[image]: $rawRepositoryVersionUrl/.github/images/change.png"
